...
def test_process_duplicate_label_role_CFC(
        duplicate_label_role_CFC: DuplicateLabelRoleCustomFeatureConverter) -> None:
    """
...
@pytest.fixture
def duplicate_label_role_CFC(
        execution_context: ExecutionContext) -> DuplicateLabelRoleCustomFeatureConverter:
